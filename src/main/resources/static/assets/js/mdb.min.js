jQuery.easing.jswing = jQuery.easing.swing, jQuery.extend(jQuery.easing, {
        ...
        return function(t, e, i, n) {
                                ...
                                if (a(C)) {
                                    ...
                                    for (var M in d.visibility !== n && "hidden" !== d.visibility && y.setPropertyValue(C, "visibility", d.visibility), k)
                                        if ("element" !== M) {
                                            ...
                                            if (1 === v) T = O.endValue;
                                            else { var P = O.endValue - O.startValue; if (T = O.startValue + P * _(v, d, P), !f && T === O.currentValue) continue }
            ...
            if (!(7 >= d)) {
                ...
                var x = function() {
                    function t() { return d ? O.promise || null : h }
                            ...
                            if ("scroll" === T) {
                                ...
                                for (var D in a(r).tweensContainer && !0 === a(r).isAnimating && (A = a(r).tweensContainer), u.each(b, function(t, e) {
                                    ...
                                    if (a(r).isSVG || "tween" === H || !1 !== y.Names.prefixCheck(H)[1] || y.Normalizations.registered[H] !== n) {
                                        ...
                                        var N, B, j, Y = !1;
                                        if (V = (N = f(D, V))[0], j = N[1], R = (N = f(D, R))[0].replace(/^([+-\/*])=/, function(t, e) { return Y = e, "" }), B = N[1], V = parseFloat(V) || 0, R = parseFloat(R) || 0, "%" === B && (/^(fontSize|lineHeight)$/.test(D) ? (R /= 100, B = "em") : /^scale/.test(D) ? (R /= 100, B = "") : /(Red|Green|Blue)$/i.test(D) && (R = R / 100 * 255, B = "")), /[\/*]/.test(Y)) B = j;
                                        else if (j !== B && 0 !== V)
                                            if (0 === R) B = j;
                                            else {
                                                o = o || m();
                                        ...
                                        d[D] = { rootPropertyValue: z, startValue: V, currentValue: V, endValue: R, unitType: B, easing: W }, g.debug && console.log("tweensContainer (" + D + "): " + JSON.stringify(d[D]), r)
                    ...
                    if (p.isWrapped(this) ? (d = !1, f = 0, v = this, h = this) : (d = !0, f = 1, v = k ? arguments[0].elements || arguments[0].e : arguments[0]), v = o(v)) {
                        ...
                        switch (d && g.Promise && (O.promise = new g.Promise(function(t, e) { O.resolver = t, O.rejecter = e })), b) {
                            case "scroll":
                                T = "scroll";
                                break;
                            case "reverse":
                        ...
                        var $, D, E = { lastParent: null, lastPosition: null, lastFontSize: null, lastPercentToPxWidth: null, lastPercentToPxHeight: null, lastEmToPx: null, remToPx: null, vwToPx: null, vhToPx: null },
                            L = [];
                        if (u.each(v, function(t, e) { p.isNode(e) && r.call(e) }), (D = u.extend({}, g.defaults, w)).loop = parseInt(D.loop), $ = 2 * D.loop - 1, D.loop)
                            for (var F = 0; $ > F; F++) {
                    ...
                    update: function(t, e, i) {
                        if (t) {
                            ...
                            var P = l,
                                ...
                                I = u,
                                $ = d;
                            n.each(h.concat(p), V), n.each(h, function(t) { P += t.width }), n.each(p, function(t) { A += t.width }), n.each(f.concat(m), V), n.each(f, function(t) { I += t.height }), n.each(m, function(t) { $ += t.height }), n.each(h.concat(p), function(t) {
                                var e = n.findNextWhere(S, function(e) { return e.box === t }),
                                    i = { left: 0, right: 0, top: I, bottom: $ };
                                e && t.update(e.minSize.width, C, i)
                            }), P = l, A = c, I = u, $ = d, n.each(h, function(t) { P += t.width }), n.each(p, function(t) { A += t.width }), n.each(f, function(t) { I += t.height }), n.each(m, function(t) { $ += t.height });
                            ...
                            var L = i - I - $,
                                F = e - P - A;
                            F === k && L === C || (n.each(h, function(t) { t.height = L }), n.each(p, function(t) { t.height = L }), n.each(f, function(t) { t.fullWidth || (t.width = F) }), n.each(m, function(t) { t.fullWidth || (t.width = F) }), C = L, k = F);
                            var R = l + D,
                                W = u + E;
                            n.each(h.concat(f), H), R += k, W += C, n.each(p, H), n.each(m, H), t.chartArea = { left: P, top: I, right: P + k, bottom: I + C }, n.each(v, function(e) { e.left = t.chartArea.left, e.top = t.chartArea.top, e.right = t.chartArea.right, e.bottom = t.chartArea.bottom, e.update(k, C) })
                        }
                        ...
                        function H(t) { t.isHorizontal() ? (t.left = t.fullWidth ? l : P, t.right = t.fullWidth ? e - c : P + k, t.top = W, t.bottom = W + t.height, W = t.bottom) : (t.left = R, t.right = R + t.width, t.top = I, t.bottom = I + C, R = t.right) }
                    }
                }
            }, { 46: 46 }],
            32: [function(t, e, i) {
                        ...
                        if (i.display) {
                            ...
                            if (a.each(v, function(n, o) {
                                    if (!a.isNullOrUndef(n.label)) {
                                        ...
                                        T.push({ tx1: g, ty1: b, tx2: y, ty2: x, x1: k, y1: C, x2: S, y2: $, labelX: D, labelY: E, glWidth: c, glColor: u, glBorderDash: d, glBorderDashOffset: p, rotation: -1 * M, label: L, major: n.major, textBaseline: R, textAlign: F })
                                    }
                                }), a.each(T, function(t) {
    ...
    function(t, e) { "object" == typeof exports && "undefined" != typeof module ? module.exports = e(require("chart.js")) : "function" == typeof define && define.amd ? define(["chart.js"], e) : (t = t || self).ChartDataLabels = e(t.Chart) }(this, function(t) {
            ...
            n = {
                ...
                parseFont: function(i) {
                    var o = t.defaults.global,
                        ...
                        r = { family: e.valueOrDefault(i.family, o.defaultFontFamily), lineHeight: e.options.toLineHeight(i.lineHeight, a), size: a, style: e.valueOrDefault(i.style, o.defaultFontStyle), weight: e.valueOrDefault(i.weight, null), string: "" };
        ...
        function u(t, e, i) { var n = a; return t < i.left ? n |= r : t > i.right && (n |= s), e < i.top ? n |= c : e > i.bottom && (n |= l), n }

        function d(t, e) {
            var i, n, o = e.anchor,
                a = t;
            return e.clamp && (a = function(t, e) { for (var i, n, o, a = t.x0, d = t.y0, h = t.x1, p = t.y1, f = u(a, d, e), m = u(h, p, e); f | m && !(f & m);)(i = f || m) & c ? (n = a + (h - a) * (e.top - d) / (p - d), o = e.top) : i & l ? (n = a + (h - a) * (e.bottom - d) / (p - d), o = e.bottom) : i & s ? (o = d + (p - d) * (e.right - a) / (h - a), n = e.right) : i & r && (o = d + (p - d) * (e.left - a) / (h - a), n = e.left), i === f ? f = u(a = n, d = o, e) : m = u(h = n, p = o, e); return { x0: a, x1: h, y0: d, y1: p } }(a, e.area)), "start" === o ? (i = a.x0, n = a.y0) : "end" === o ? (i = a.x1, n = a.y1) : (i = (a.x0 + a.x1) / 2, n = (a.y0 + a.y1) / 2),
                function(t, e, i, n, o) {
                    switch (o) {
                        case "center":
                            i = n = 0;
        ...
        var h = {
                ...
                rect: function(t, e) {
                    var i = o(t, e.origin),
                        ...
                        r = 0,
                        s = 0;
                    return t.horizontal ? (n = Math.min(t.x, t.base), r = Math.abs(t.base - t.x)) : (a = Math.min(t.y, t.base), s = Math.abs(t.base - t.y)), d({ x0: n, y0: a + s, x1: n + r, y1: a, vx: i.x, vy: i.y }, e)
                },
            ...
            update: function(t) {
                ...
                u && (e = t.dataset.data[l], i = p.valueOrDefault(p.callback(c.formatter, [e, t]), e), (o = p.isNullOrUndef(i) ? [] : n.toTextLines(i)).length && (s = function(t) {
                    var e = t.borderWidth || 0,
                        ...
                        a = -o / 2,
                        r = -n / 2;
                    return { frame: { x: a - i.left - e, y: r - i.top - e, w: o + i.width + 2 * e, h: n + i.height + 2 * e }, text: { x: a, y: r, w: o, h: n } }
                    ...
                    if (c && (s || h))
                        for (i = function(t, e, i) {
                                var n = i.lineHeight,
                                    o = t.w,
                                    a = t.x;
                                return "center" === e ? a += o / 2 : "end" !== e && "right" !== e || (a += o), { h: n, w: o, x: a, y: t.y + n / 2 }
                            }(i, a, l), t.font = l.string, t.textAlign = a, t.textBaseline = "middle", t.shadowBlur = n.textShadowBlur, t.shadowColor = n.textShadowColor, s && (t.fillStyle = r), h && (t.lineJoin = "round", t.lineWidth = d, t.strokeStyle = u), o = 0, c = e.length; o < c; ++o) v(t, e[o], { stroked: h, filled: s, w: i.w, x: i.x, y: i.y + i.h * o })
        ...
        var S = function() { this._rotation = 0, this._rect = { x: 0, y: 0, w: 0, h: 0 } };
        ...
        var T = {
                prepare: function(t) {
                    ...
                    for (e = 0, n = t.length; e < n; ++e)
                        for (i = 0, o = t[e].length; i < o; ++i) a = t[e][i], r.push(a), a.$layout = { _box: new S, _hidable: !1, _visible: !0, _set: e, _idx: i };
                ...
                draw: function(t, e) { var i, n, o, a, r, s; for (i = 0, n = e.length; i < n; ++i)(a = (o = e[i]).$layout)._visible && (r = o.geometry(), s = M(o._el._view, o.model(), r), a._box.update(s, r, o.rotation()), o.draw(t, s)) }
            },
            O = t.helpers,
            _ = {
                align: "center",
                ...
                var n, o, a, r, s, l, c, u, d = e.index,
                    ...
                    v = function(t, e) {
                        var i, n, o, a = t.datalabels,
                            r = [];
                        return !1 === a ? null : (!0 === a && (a = {}), e = P.merge({}, [e, a]), n = e.labels || {}, o = Object.keys(n), delete e.labels, o.length ? o.forEach(function(t) { n[t] && r.push(P.merge({}, [e, n[t], { _key: t }])) }) : r.push(e), i = r.reduce(function(t, e) { return P.each(e.listeners || {}, function(i, n) { t[n] = t[n] || {}, t[n][e._key || I] = i }), delete e.listeners, t }, {}), { labels: r, listeners: i })
                    }(m, i),
                    b = e.meta.data || [],
                    y = t.ctx;
                for (y.save(), n = 0, a = b.length; n < a; ++n)
                    if ((c = b[n])[A] = [], f && c && !c.hidden && !c._model.skip)
                        for (o = 0, r = v.labels.length; o < r; ++o) l = (s = v.labels[o])._key, (u = new g(s, y, c, n)).$groups = { _set: d, _key: l || I }, u.$context = { active: !1, chart: t, dataIndex: n, dataset: m, datasetIndex: d }, u.update(u.$context), c[A].push(u), p.push(u);
                y.restore(), P.merge(h._listeners, v.listeners, { merger: function(t, i, n) { i[t] = i[t] || {}, i[t][e.index] = n[t], h._listened = !0 } })
            },
            afterUpdate: function(t, e) { t[A]._labels = T.prepare(t[A]._datasets, e) },
            afterDatasetsDraw: function(t) { T.draw(t, t[A]._labels) },
        ...
        var e = function() {
                function e() {}
                return e.prototype.init = function() { t(".wow").wow() }, e
            }(),
            i = function() {
                function e(t, e) { this.$wowElement = t, this.customization = e, this.animated = !0, this.options = this.assignElementCustomization() }
                var i = e.prototype;
                return i.init = function() {
                    var e = this;
                    t(window).scroll(function() { e.animated ? e.hide() : e.mdbWow() }), this.appear()
                }, i.assignElementCustomization = function() { return { animationName: this.$wowElement.css("animation-name"), offset: 100, iteration: this.fallback().or(this.$wowElement.data("wow-iteration")).or(1).value(), duration: this.fallback().or(this.$wowElement.data("wow-duration")).or(1e3).value(), delay: this.fallback().or(this.$wowElement.data("wow-delay")).or(0).value() } }, i.mdbWow = function() { var t = this; "visible" !== this.$wowElement.css("visibility") && this.shouldElementBeVisible(!0) && (setTimeout(function() { return t.$wowElement.removeClass("animated") }, this.countRemoveTime()), this.appear()) }, i.appear = function() { this.$wowElement.addClass("animated"), this.$wowElement.css({ visibility: "visible", "animation-name": this.options.animationName, "animation-iteration-count": this.options.iteration, "animation-duration": this.options.duration, "animation-delay": this.options.delay }) }, i.hide = function() {
                    var t = this;
                    ...
                    var e = t.getBoundingClientRect(),
                        ...
                        r = e.top + o - a;
                    return Math.round(r)
                }, i.fallback = function() { return { _value: void 0, or: function(t) { return void 0 !== t && void 0 === this._value && (this._value = t), this }, value: function() { return this._value } } }, e
            }();
        t.fn.wow = function(e) { this.each(function() { new i(t(this), e).init() }) }, window.WOW = e
    }), jQuery(function(t) {
    ...
    }), $(document).ready(function() { Waves.attach(".btn:not(.btn-flat), .btn-floating", ["waves-light"]), Waves.attach(".btn-flat", ["waves-effect"]), Waves.attach(".chip", ["waves-effect"]), Waves.attach(".view a .mask", ["waves-light"]), Waves.attach(".waves-light", ["waves-light"]), Waves.attach(".navbar-nav a:not(.navbar-brand), .nav-icons li a, .nav-tabs .nav-item:not(.dropdown)", ["waves-light"]), Waves.attach(".pager li a", ["waves-light"]), Waves.attach(".pagination .page-item .page-link", ["waves-effect"]), Waves.init() }), jQuery(function(t) {
        (new(function() {
            function e() { this.inputSelector = ["text", "password", "email", "url", "tel", "number", "search", "search-md"].map(function(t) { return "input[type=" + t + "]" }).join(", ") + ", textarea", this.textAreaSelector = ".materialize-textarea", this.$text = t(".md-textarea-auto"), this.$body = t("body"), this.$document = t(document) }
            var i = e.prototype;
            return i.init = function() {
                var e, i = this;
                this.$text.length && (e = window.attachEvent ? function(t, e, i) { t.attachEvent("on" + e, i) } : function(t, e, i) { t.addEventListener(e, i, !1) }, this.$text.each(function() {
                    var t = this;

                    function i() { t.style.height = "auto", t.style.height = t.scrollHeight + "px" }
            ...
            }, i.makeActiveAutofocus = function() { this.toggleActiveClass(t("input[autofocus]"), "add") }, i.toggleActiveClass = function(t, e) {
                var i;
                e += "Class", i = t.parent().hasClass("timepicker") ? "label" : "label, i, .input-prefix", t.siblings(i)[e]("active")
            }, i.addOnFocusEvent = function() {
                var e = this;
                this.$document.on("focus", this.inputSelector, function(i) { e.toggleActiveClass(t(i.target), "add") })
                ...
                e.each(function(t, e) { e.type = "text" }), e.on("focus", function(t) { t.target.type = "date" }), e.on("blur", function(e) { e.target.type = "text", 0 === e.target.value.length && t("label[for=" + e.target.id + "]").removeClass("active") })
...
function preloaderFading() { $("#mdb-preloader").fadeOut("slow"), $("body").removeAttr("aria-busy") }
...
$(window).on("load", function() { windowLoaded = !0 }), jQuery(function(t) { t("body").attr("aria-busy", !0), t("#preloader-markup").load(loader_path, function() { windowLoaded ? preloaderFading() : t(window).on("load", function() { preloaderFading() }) }) }), jQuery(function(t) {
    ...
    function(t) {
    ...
    }("function" == typeof define && define.amd ? define : function(t, e) { "undefined" != typeof module && module.exports ? module.exports = e(require("jquery")) : window.toastr = e(window.jQuery) }), jQuery(function() {
        ...
        var e = function() {
            ...
            return i.assignOptions = function(e) { return t.extend({}, this.defaults, e) }, i.init = function() { this.setMenuWidth(), this.setMenuTranslation(), this.closeOnClick(), this.openOnClick(), this.bindTouchEvents(), this.showCloseButton(), this.inputOnClick(), !0 === this.options.slim && this.handleSlim(), this.onOpen(), this.onClose(), this.options[0] + this.options[1] + this.options[2] + this.options[3] === "show" && !1 === this.menuOut && this.$element.trigger("click"), this.options[0] + this.options[1] + this.options[2] + this.options[3] === "hide" && !0 === this.menuOut && this.removeMenu() }, i.setMenuWidth = function() {
            ...
            }, i.closeOnClick = function() { var t = this;!0 === this.options.closeOnClick && (this.$menu.on("click", "a:not(.collapsible-header)", function() { return t.removeMenu() }), "translateX(0)" === this.$menu.css("transform") && this.$menu.on("click", function() { return t.removeMenu() })) }, i.onOpen = function(e) { t(this).on("sidenav_open", function(t, e) { "function" == typeof e && e() }) }, i.onClose = function(e) { t(this).on("sidenav_close", function(t, e) { "function" == typeof e && e() }) }, i.openOnClick = function() {
                var e = this;
                this.$element.on("click", function(i) {
                    ...
                    var n = [];
                    n = "left" === e.options.edge ? [0, -1 * e.options.menuWidth] : [0, e.options.menuWidth], "matrix(1, 0, 0, 1, 0, 0)" !== e.$menu.css("transform") && e.$menu.velocity({ translateX: n }, { duration: e.options.timeDurationOpen, queue: !1, easing: e.options.easingOpen }), e.$sidenavOverlay.on("touchmove", e.touchmoveEventHandler.bind(e)), e.$menu.on("touchmove", function(t) { t.preventDefault(), e.$menu.find(".custom-scrollbar").css("padding-bottom", "30px") }), !1 === e.options.showOverlay && (e.menuOut = !0)
                })
            }, i.bindTouchEvents = function() {
                var t = this;
                this.$dragTarget.on("click", function() { t.menuOut && t.removeMenu() }), this.$dragTarget.on("touchstart", function(e) { t.lastTouchVelocity.x.startPosition = e.touches[0].clientX, t.lastTouchVelocity.x.startTime = Date.now() }), this.$dragTarget.on("touchmove", this.touchmoveEventHandler.bind(this)), this.$dragTarget.on("touchend", this.touchendEventHandler.bind(this))
            }, i.showCloseButton = function() {!0 === this.options.showCloseButton && (this.$menu.prepend(this.$elementCloned), this.$menu.find(".logo-wrapper").css({ borderTop: "1px solid rgba(153,153,153,.3)" })) }, i.inputOnClick = function() {
                var t = this;
                this.$menu.find("input[type=text]").on("touchstart", function() { return t.$menu.css("transform", "translateX(0)") })
            }, i.removeMenu = function(e) {
                var i = this;
                this.$body.css({ overflow: "", width: "" }), this.$menu.velocity({ translateX: "left" === this.options.edge ? "-100%" : "100%" }, { duration: this.options.timeDurationClose, queue: !1, easing: this.options.easingClose, complete: function() {!0 === e && (i.$menu.removeAttr("style"), i.$menu.css("width", i.options.menuWidth)) } }), this.$menu.removeClass("transform-fix-input"), this.hideSidenavOverlay(), this.menuOut = !1, t(".fixed-sn .double-nav").css("padding-left", "unset"), t(".fixed-sn main, .fixed-sn footer").css({ "padding-left": "0" }), t(this).trigger("sidenav_close", [this.options.onClose])
            ...
            }, i.calculateTouchVelocityX = function() { return Math.abs(this.lastTouchVelocity.x.endPosition - this.lastTouchVelocity.x.startPosition) / Math.abs(this.lastTouchVelocity.x.endTime - this.lastTouchVelocity.x.startTime) }, i.touchendEventHandler = function(t) {
                if ("touchend" === t.type) {
                    ...
                    o > 0 && (o = 0), a < 0 && (a = 0), "left" === this.options.edge ? (this.menuOut || i <= this.settings.menuLeftMinBorder || i < this.options.menuLeftMaxBorder ? (0 !== o && this.translateMenuX([0, o], "300"), this.showSidenavOverlay()) : (!this.menuOut || i > this.settings.menuLeftMinBorder) && (this.enableScrolling(), this.translateMenuX([-1 * this.options.menuWidth - this.options.menuVelocityOffset, o], "200"), this.hideSidenavOverlay()), this.$dragTarget.css({ width: "10px", right: "", left: 0 })) : this.menuOut && i >= this.settings.menuRightMinBorder || i > this.settings.menuRightMaxBorder ? (this.translateMenuX([0, a], "300"), this.showSidenavOverlay(), this.$dragTarget.css({ width: "50%", right: "", left: 0 })) : (!this.menuOut || i < this.settings.menuRightMinBorder) && (this.enableScrolling(), this.translateMenuX([this.options.menuWidth + this.options.menuVelocityOffset, a], "200"), this.hideSidenavOverlay(), this.$dragTarget.css({ width: "10px", right: 0, left: "" }))
                }
            }, i.buildSidenavOverlay = function() { var e = this;!0 === this.options.showOverlay && (this.$sidenavOverlay = t('<div id="sidenav-overlay"></div>'), this.$sidenavOverlay.css("opacity", 0).on("click", function() { return e.removeMenu() }), this.$body.append(this.$sidenavOverlay)) }, i.disableScrolling = function() {
                var t = this.$body.innerWidth();
                this.$body.css("overflow", "hidden"), this.$body.width(t)
            }, i.enableScrolling = function() { this.$body.css({ overflow: "", width: "" }) }, i.translateMenuX = function(t, e) { this.$menu.velocity({ translateX: t }, { duration: "string" == typeof e ? Number(e) : e, queue: !1, easing: this.options.easingOpen }) }, i.translateSidenavX = function(t) {
            ...
            }, i.showSidenavOverlay = function() {!0 !== this.options.showOverlay || t("#sidenav-overlay").length || this.buildSidenavOverlay(), this.$sidenavOverlay.velocity({ opacity: 1 }, { duration: this.options.timeDurationOverlayOpen, queue: !1, easing: this.options.easingOpen }) }, i.hideSidenavOverlay = function() { this.$sidenavOverlay.velocity({ opacity: 0 }, { duration: this.options.timeDurationOverlayClose, queue: !1, easing: this.options.easingOpen, complete: function() { t(this).remove() } }) }, e
        }();
        ...
        function a(t, e, i, n, o, a, r) { t.velocity({ height: e, width: i, top: n, marginLeft: o }, { duration: a, easing: r || "swing" }) }

        function r(t) { a(t, "30px", "30px", "-27px", "-7px", 200, "easeOutExpo") }

        function s(t) { a(t, "0", "0", "10px", "7px", 200) }
        ...
        var e = function() {
            ...
            e.mdbDropdownAutoInit = function() { t(".dropdown-button").dropdown(), this.bindMultiLevelDropdownEvents(), this.bindBootstrapEvents() }, e.bindMultiLevelDropdownEvents = function() {
                ...
                }), t(".multi-level-dropdown .dropdown").on("hidden.bs.dropdown", function() { t(".multi-level-dropdown .dropdown-menu.show").removeClass("show") })
                ...
                t(".dropdown, .dropup").on({
                    ...
                    "hide.bs.dropdown": function(i) {
                        ...
                        a.effectOut && (n || i.preventDefault(), e._dropdownEffectStart(o, a.effectOut), e._dropdownEffectEnd(o, a, function() { o.removeClass("show"), o.find(".dropdown-menu").removeClass("show") }))
                    }
                })
            ...
            }, e._dropdownEffectStart = function(t, e) { e && (t.addClass("dropdown-animating"), t.find(".dropdown-menu").addClass(["animated", e].join(" "))) }, e._dropdownEffectEnd = function(t, e, i) { t.one("webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend", function() { t.removeClass("dropdown-animating"), t.find(".dropdown-menu").removeClass(["animated", e.effectIn, e.effectOut].join(" ")), "function" == typeof i && i() }) };
            var i = e.prototype;
            return i.returnPublicInterface = function() { return { $activator: this.$activator, $activates: this.$activates, updatePosition: this.updatePosition.bind(this) } }, i.init = function() { this.appendDropdownToActivator(), this.options.hover ? this.handleHoverableDropdown() : this.handleClickableDropdown(), this.bindEvents() }, i.appendDropdownToActivator = function() { this.$activator.after(this.$activates) }, i.handleHoverableDropdown = function() {
                var e = this,
                    i = !1;
                this.$activator.unbind("click." + this.$activator.attr("id")), this.$activator.on("mouseenter", function() {!1 === i && (e.placeDropdown(), i = !0) }), this.$activator.on("mouseleave", function(n) {
                ...
                this.$activator.unbind("click." + this.$activator.attr("id")), this.$activator.bind("click." + this.$activator.attr("id"), function(i) {
                    if (!e.isFocused) {
                        ...
                        !n || o || a ? o && (e.hideDropdown(), t(document).unbind("click." + e.$activates.attr("id") + " touchstart." + e.$activates.attr("id"))) : (i.preventDefault(), e.placeDropdown("click")), e.$activates.hasClass("active") && t(document).bind("click." + e.$activates.attr("id") + " touchstart." + e.$activates.attr("id"), function(i) {!e.$activates.is(i.target) && !e.$activator.is(i.target) && !e.$activator.find(i.target).length && (e.hideDropdown(), t(document).unbind("click." + e.$activates.attr("id") + " touchstart." + e.$activates.attr("id"))) })
                    }
                })
            ...
            }, i.placeDropdown = function(t) { "focus" === t && (this.isFocused = !0), this.$activates.addClass("active"), this.$activator.addClass("active"), !0 === this.options.constrainWidth ? this.$activates.css("width", this.$activator.outerWidth()) : this.$activates.css("white-space", "nowrap"), this.updatePosition(), this.showDropdown() }, i.showDropdown = function() { this.$activates.stop(!0, !0).css("opacity", 0).slideDown({ queue: !1, duration: this.options.inDuration, easing: this.options.easingEffectIn, complete: function() { t(this).css("height", "") } }).animate(_objectSpread({ opacity: 1 }, this.options.resetScroll && { scrollTop: 0 }), { queue: !1, duration: this.options.inDuration, easing: "easeOutSine" }) }, i.hideDropdown = function() {
                var t = this;
                ...
                else if ("right" === o) { r = this.$activator.position().left + this.$activator.outerWidth() - this.$activates.outerWidth() + (a = -this.options.gutter) }
                this.$activates.css({ position: "absolute", top: this.$activator.position().top + l + c, left: r })
            }, i._getHorizontalAlignment = function() { var e = this.$activator.offset().left; return e + this.$activates.innerWidth() > t(window).width() ? "right" : e - this.$activates.innerWidth() + this.$activator.innerWidth() < 0 ? "left" : this.options.alignment }, i.fallback = function() { return { _value: void 0, or: function(t) { return void 0 !== t && void 0 === this._value && (this._value = t), this }, value: function() { return this._value } } }, e
        }();
        ...
        }, t.dropdown = { initAnimations: function() { e.bindBootstrapEvents() } }, e.mdbDropdownAutoInit()
    }), jQuery(function(t) {
        var e = function() {
            function e(t, e) { void 0 === e && (e = {}), this.$searchWrappers = t, this.options = { color: this.fallback().or(e.color).or("#000").value(), backgroundColor: this.fallback().or(e.backgroundColor).or("").value(), fontSize: this.fallback().or(e.fontSize).or(".9rem").value(), fontWeight: this.fallback().or(e.fontWeight).or("400").value(), borderRadius: this.fallback().or(e.borderRadius).or("").value(), borderColor: this.fallback().or(e.borderColor).or("").value(), margin: this.fallback().or(e.margin).or("").value() } }
            var i = e.prototype;
            return i.init = function() { return this.bindSearchEvents(), this.$searchWrappers.css({ color: this.options.color, backgroundColor: this.options.backgroundColor, fontSize: this.options.fontSize, fontWeight: this.options.fontWeight, borderRadius: this.options.borderRadius, borderColor: this.options.borderColor, margin: this.options.margin }) }, i.bindSearchEvents = function() {
...
var MaterialSelectViewRenderer = function() {
    ...
    return e.destroy = function() {
        ...
        var t = this;
        this.view.$customTemplateParts.each(function(e, i) { $(i).appendTo(t.view.$materialOptionsList).wrap("<li></li>") }), this.view.$btnSave.appendTo(this.view.$selectWrapper).clone().appendTo(this.view.$materialOptionsList)
    }, e.appendValidationFeedbackElements = function() { this.view.$validFeedback.insertAfter(this.view.$selectWrapper), this.view.$invalidFeedback.insertAfter(this.view.$selectWrapper) }, e.enableValidation = function() { this.view.$nativeSelect.css({ position: "absolute", top: "1rem", left: "0", height: "0", width: "0", opacity: "0", padding: "0", "pointer-events": "none" }), -1 === this.view.$nativeSelect.attr("style").indexOf("inline!important") && this.view.$nativeSelect.attr("style", this.view.$nativeSelect.attr("style") + " display: inline!important;"), this.view.$nativeSelect.attr("tabindex", -1), this.view.$nativeSelect.data("inherit-tabindex", !1) }, e.setMaterialOptionsListMaxHeight = function() {
    ...
    }, e.markInitialized = function() { this.view.$nativeSelect.addClass("initialized") }, e.appendSearchInputOption = function() {
        ...
        this.view.$searchInput = $('<span class="search-wrap ml-2"><div class="' + e + ' mt-0"><input type="text" class="search w-100 d-block ' + i + '" tabindex="-1" placeholder="' + t + '"></div></span>'), this.view.$materialOptionsList.append(this.view.$searchInput), this.view.$searchInput.on("click", function(t) { return t.stopPropagation() })
    }, e.appendAddOptionBtn = function() { this.view.$searchInput.append(this.view.$addOptionBtn) }, e.buildMaterialOptions = function() {
        var t = this;
...
var MaterialSelectView = function() {
    ...
    var e = t.prototype;
    return e.destroy = function() { this.renderer.destroy() }, e.render = function() { this.renderer.render() }, e.selectPreselectedOptions = function(t) {
        var e = this;
    ...
    }, e.bindAddNewOptionClick = function() { this.$addOptionBtn.on("click", this.renderer.addNewOption.bind(this.renderer)) }, e.bindMaterialSelectFocus = function() {
        var t = this;
    ...
    }, e.bindMaterialOptionsListTouchstart = function() { this.$materialOptionsList.on("touchstart", function(t) { return t.stopPropagation() }) }, e.bindMaterialSelectKeydown = function() {
        var t = this;
        ...
        var t = this;
        $("html").on("click", function(e) { $(e.target).closest("#select-options-" + t.properties.id).length || $(e.target).hasClass("mdb-select") || !$("#select-options-" + t.properties.id).hasClass("active") || (t.$materialSelect.trigger("close"), t.$materialSelect.val() || t.options.placeholder || t.$mainLabel.removeClass("active")), t.isSearchable && null !== t.$searchInput && t.$materialOptionsList.hasClass("active") && t.$materialOptionsList.find(".search-wrap input.search").focus() })
    }, e.bindMobileDevicesMousedown = function() { $("select").siblings("input.select-dropdown", "input.multi-bs-select").on("mousedown", function(e) { t.isMobileDevice && (e.clientX >= e.target.clientWidth || e.clientY >= e.target.clientHeight) && e.preventDefault() }) }, e.bindSaveBtnClick = function() {
        var t = this;
    ...
    }, e._isToggleAllPresent = function() { return this.$materialOptionsList.find(this.$toggleAll).length }, e._isPlaceholderPresent = function() { return !(!this.$nativeSelect.attr("data-placeholder") && !this.options.placeholder) }, e._updateToggleAllOption = function() {
        ...
        if (t === this.keyCodes.arrowUp) {
            ...
            c = d, o.each(function(t, e) { $(e).hasClass(i.options.keyboardActiveClass) && (d = o.eq(t - 1), c = o.eq(t)) }), l = u.is(a) || !s ? u : d
        } else {
            var h = s ? this.$materialOptionsList.find("li.selected").first() : a,
                p = h.next("li" + n + ":not(.disabled, .select-toggle-all)");
            c = p, o.each(function(t, e) { $(e).hasClass(i.options.keyboardActiveClass) && (p = o.eq(t + 1), c = o.eq(t)) }), l = h.is(r) || !s ? h : p
        }
        return { $matchedMaterialOption: l, $activeOption: c }
    }, e._handleHomeKey = function() { this._selectBoundaryOption("first") }, e._handleEndKey = function() { this._selectBoundaryOption("last") }, e._selectBoundaryOption = function(t) {
        void 0 === t && (t = "");
    ...
    }, e._handleEscKey = function(t) { this._removeKeyboardActiveClass(), t.trigger("close") }, e._handleLetterKey = function(t) {
        var e = this;
    ...
    }, e._removeKeyboardActiveClass = function() { this.$materialOptionsList.find("li").removeClass(this.options.keyboardActiveClass) }, e._triggerChangeOnNativeSelect = function() {
        var t = new KeyboardEvent("change", { bubbles: !0, cancelable: !0 });
        this.$nativeSelect.get(0).dispatchEvent(t)
    }, e._selectSingleOption = function(t) { this.$materialOptionsList.find("li.selected").removeClass("selected"), this._selectOption(t) }, e._updateDropdownScrollTop = function() {
...
jQuery(function(t) {
        var e, i = function() {
            ...
            return i.init = function() {
            ...
            }, i._onMutationObserverChange = function(e) { e.forEach(function(e) { var i = t(e.target).closest("select");!0 !== i.data("stop-refresh") && ("childList" === e.type || "attributes" === e.type && t(e.target).is("option")) && (i.materialSelect({ destroy: !0 }), i.materialSelect()) }) }, i._resetSelection = function() { this.selectedOptionsIndexes = [], this.view.$nativeSelect.find("option").prop("selected", !1) }, i._toggleSelectedValue = function(t) {
                ...
                this.selectedOptionsIndexes.forEach(function(i) { return e += ", " + t.view.$nativeSelect.find("option").eq(i).text().replace(/  +/g, " ").trim() }), 0 === (e = this.options.maxSelectedOptions >= 0 && i > this.options.maxSelectedOptions ? i + " " + this.options.labels.optionsSelected : e.substring(2)).length && (e = this.view.$nativeSelect.find("option:disabled").eq(0).text()), this.view.$nativeSelect.siblings(this.options.defaultMaterialInput ? "input.multi-bs-select" : "input.select-dropdown").val(e)
            }, i._randomUUID = function() { var t = (new Date).getTime(); return "xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx".replace(/[xy]/g, function(e) { var i = (t + 16 * Math.random()) % 16 | 0; return t = Math.floor(t / 16), ("x" === e ? i : 3 & i | 8).toString(16) }) }, i.fallback = function() { return { _value: void 0, or: function(t) { return void 0 !== t && void 0 === this._value && (this._value = t), this }, value: function() { return this._value } } }, _createClass(e, [{ key: "isInitialized", get: function() { return Boolean(this.view.$nativeSelect.data("select-id")) && this.view.$nativeSelect.hasClass("initialized") } }]), e
        }();
    ...
    function(t) { "function" == typeof define && define.amd ? define("picker", ["jquery"], t) : "object" == typeof exports ? module.exports = t(require("jquery")) : window.Picker = t(jQuery) }(function(t) {
        var e = t(window),
            i = t(document),
    ...
    function() {
        ...
        function M(t, e) {
            ...
            if (e.min && ($("min"), this.minMinutes = this.minTime[1], this.minHours = this.minTime[0]), e.max && ($("max"), this.minHours > this.maxHours || this.minHours === this.maxHours && this.minMinutes >= this.maxMinutes ? this.maxTime = 0 : (this.maxMinutes = this.maxTime[1], this.maxHours = this.maxTime[0])), e.twelvehour) {
                ...
                n(D);
                const t = t => { let e = "pm"; "PM" === t && (e = "am"), I.amOrPm = t, I.amPmBlock.children(`.${e}-button`).removeClass("active"), I.amPmBlock.children(`.${t.toLowerCase()}-button`).addClass("active"), I.spanAmPm.empty().append(t), this.disableOutOfRangeElements() };
                e.ampmclickable ? (this.spanAmPm.empty(), n('<div id="click-am">AM</div>').on("click", function() { I.spanAmPm.children("#click-am").addClass("text-primary"), I.spanAmPm.children("#click-pm").removeClass("text-primary"), I.amOrPm = "AM" }).appendTo(this.spanAmPm), n('<div id="click-pm">PM</div>').on("click", function() { I.spanAmPm.children("#click-pm").addClass("text-primary"), I.spanAmPm.children("#click-am").removeClass("text-primary"), I.amOrPm = "PM" }).appendTo(this.spanAmPm)) : (n('<button type="button" class="btn-floating btn-flat clockpicker-button am-button" tabindex="1">AM</button>').on("click", function() { t("AM") }).appendTo(this.amPmBlock), n('<button type="button" class="btn-floating btn-flat clockpicker-button pm-button" tabindex="2">PM</button>').on("click", function() { t("PM") }).appendTo(this.amPmBlock))
            }
            ...
            if (e.twelvehour)
                for (E = 0; E < 12; E += e.hourstep) L = W.clone(), F = E / 6 * Math.PI, R = y, L.css("font-size", "140%"), L.css({ left: b + Math.sin(F) * R - w, top: b - Math.cos(F) * R - w }), L.html(0 === E ? 12 : E), p.append(L), L.on(u, z), this.disableOutOfRangeElements();
            else
                for (E = 0; E < 24; E += e.hourstep) {
                    L = W.clone(), F = E / 6 * Math.PI;
                    var V = E > 0 && E < 13;
                    R = V ? x : y, L.css({ left: b + Math.sin(F) * R - w, top: b - Math.cos(F) * R - w }), V && L.css("font-size", "120%"), L.html(0 === E ? "00" : E), p.append(L), L.on(u, z), this.disableOutOfRangeElements()
                }
            var H = Math.max(e.minutestep, 5);
            for (E = 0; E < 60; E += H)
                for (E = 0; E < 60; E += 5) L = W.clone(), F = E / 30 * Math.PI, L.css({ left: b + Math.sin(F) * y - w, top: b - Math.cos(F) * y - w }), L.css("font-size", "140%"), L.html(v(E)), M.append(L), L.on(u, z);
            ...
            function z(t, i) {
                ...
                if (!i || !(f < y - w || f > y + w)) {
                    t.preventDefault();
                    var v = setTimeout(function() { I.popover.addClass("clockpicker-moving") }, 200);
                    s && l.append(I.canvas), I.setHand(u, p, !i, !0), a.off(d).on(d, function(t) {
                        ...
                        "PM" === b && (x < 12 && (x = 0), x > 12 && (x -= 12), y > 12 && (y -= 12)), I.isInvalidTimeScope ? (I.isInvalidTimeScope = !1, t.stopPropagation()) : "hours" === I.currentView ? I.toggleView("minutes", C / 2) : "hours" != I.currentView && e.autoclose && (I.minutesView.addClass("clockpicker-dial-out"), setTimeout(function() { I.done() }, C / 2), I.currentHours = 0), l.prepend(N), clearTimeout(v), I.popover.removeClass("clockpicker-moving"), a.off(d)
                    }), I.disableOutOfRangeElements()
                }
            }
            if (l.on(u, function(t) { 0 === n(t.target).closest(".clockpicker-tick").length && z(t, !0) }), s) {
        ...
        M.DEFAULTS = { default: "", fromnow: 0, donetext: "Done", cleartext: "Clear", autoclose: !1, ampmclickable: !1, darktheme: !1, twelvehour: !1, vibrate: !0, hourstep: 1, minutestep: 1, ampmSubmit: !1, container: "body" }, M.prototype.toggle = function() { this[this.isShown ? "hide" : "show"]() }, M.prototype.locate = function() {
            ...
            }), "minutes" === i && d.each((e, i) => { s == t && i.innerHTML < c ? n(i).addClass("grey-text disabled") : r == t && i.innerHTML > l ? n(i).addClass("grey-text disabled") : n(i).removeClass("grey-text disabled") })
            ...
            this.currentView = t, this.spanHours.toggleClass("text-primary", o), this.spanMinutes.toggleClass("text-primary", !o), r.addClass("clockpicker-dial-out"), a.css("visibility", "visible").removeClass("clockpicker-dial-out"), this.resetClock(e), clearTimeout(this.toggleViewTimer), this.toggleViewTimer = setTimeout(function() { r.css("visibility", "hidden") }, C), this.disableOutOfRangeElements(), i && T(this.options.afterHourSelect)
            ...
            if (c) { let t = r; if ("PM" === this.amOrPm && (m < 12 && (m = 0), m > 12 && (m -= 12), g > 12 && (g -= 12)), this.isTwelvehour && 12 == t && (t = 0), t < m || t > g) return void(this.isInvalidTimeScope = !0); if (this.isTwelvehour && 12 === t) return void(this.isInvalidTimeScope = !0) } else { let { hours: t } = this; if ("PM" === k && (t += 12), t == m && r < b || t == g && r > w) return void(this.isInvalidTimeScope = !0) }
            if (c ? this.fg.setAttribute("class", "clockpicker-canvas-fg") : r % 5 == 0 ? this.fg.setAttribute("class", "clockpicker-canvas-fg") : this.fg.setAttribute("class", "clockpicker-canvas-fg active"), this[this.currentView] !== r && p && this.options.vibrate && (this.vibrateTimer || (navigator[p](10), this.vibrateTimer = setTimeout(n.proxy(function() { this.vibrateTimer = null }, this), 100))), this[this.currentView] = r, this[c ? "spanHours" : "spanMinutes"].html(v(r)), s) {
        ...
        t.fn.dateTimePicker = function(e = ", ") {
            ...
            const o = t(`.timepicker[data-open='${i.dataset.open}']`),
                a = t(`#${i.dataset.open}`);
            a.pickadate({ onClose: function() { o.pickatime({ afterHide: () => { o.trigger("change") } }).pickatime("picker").data("clockpicker").show() }, format: "yyyy/mm/dd", formatSubmit: "yyyy/mm/dd" }), a.on("change", () => {
                let t = o.val(),
                    i = a.val();
                n[0].value = `${i}${""!==t&&""!==i?e:""}${t}`
            }), o.on("change", () => {
    ...
    function(t, e) { "function" == typeof define && define.amd ? define(e) : "object" == typeof exports ? module.exports = e() : window.PhotoSwipe = e() }(0, function() {
        "use strict";
        return function(t, e, i, n) {
            var o = {
                features: null,
            ...
            o.extend(r, n);
            var s, l, c, u, d, h, p, f, m, v, g, b, y, x, w, k, C, S, M, T, O, _, P, A, I, $, D, E, L, F, R, W, V, H, z, N, B, j, Y, q, X, U, K, Q, Z, G, J, tt, et, it, nt, ot, at, rt, st, lt = { x: 0, y: 0 },
                ct = { x: 0, y: 0 },
                ut = { x: 0, y: 0 },
                dt = {},
                ht = 0,
                ...
                wt = function(t) { var e = He(); return t > e - 1 ? t - e : 0 > t ? e + t : t },
                kt = {},
                ...
                _t = function(t) { tt && (t && (v > a.currItem.fitRatio ? yt || (Ke(a.currItem, !1, !0), yt = !0) : yt && (Ke(a.currItem), yt = !1)), Ot(tt, ut.x, ut.y, v)) },
                Pt = function(t) { t.container && Ot(t.container.style, t.initialPosition.x, t.initialPosition.y, t.initialZoomLevel, t) },
                At = function(t, e) { e[_] = b + t + "px, 0px" + y },
                It = function(t, e) {
                    if (!r.loop && e) {
                ...
                $t = function(t, e) { var i = ue[t] - pt[t]; return ct[t] + lt[t] + i - i * (e / g) },
                Dt = function(t, e) { t.x = e.x, t.y = e.y, e.id && (t.id = e.id) },
                Et = function(t) { t.x = Math.round(t.x), t.y = Math.round(t.y) },
                Lt = null,
                Ft = function() { Lt && (o.unbind(document, "mousemove", Ft), o.addClass(t, "pswp--has_mouse"), r.mouseUsed = !0, St("mouseUsed")), Lt = setTimeout(function() { Lt = null }, 100) },
                ...
                Ht = function(t, e, i, n) { return n === a.currItem.initialZoomLevel ? (i[t] = a.currItem.initialPosition[t], !0) : (i[t] = $t(t, n), i[t] > e.min[t] ? (i[t] = e.min[t], !0) : i[t] < e.max[t] && (i[t] = e.max[t], !0)) },
                zt = function(t) {
                    var e = "";
                ...
                Nt = function(t) { t && (X || q || et || N) && (t.preventDefault(), t.stopPropagation()) },
                Bt = function() { a.setScrollOffset(0, o.getScrollY()) },
                jt = {},
                Yt = 0,
                qt = function(t) { jt[t] && (jt[t].raf && $(jt[t].raf), Yt--, delete jt[t]) },
                ...
                Qt = {
                    ...
                    applyZoomPan: function(t, e, i, n) { ut.x = e, ut.y = i, v = t, _t(n) },
                    init: function() {
                        if (!s && !l) {
                            var i;
                            a.framework = o, a.template = t, a.bg = o.getChildByClass(t, "pswp__bg"), D = t.className, s = !0, R = o.detectFeatures(), I = R.raf, $ = R.caf, _ = R.transform, L = R.oldIE, a.scrollWrap = o.getChildByClass(t, "pswp__scroll-wrap"), a.container = o.getChildByClass(a.scrollWrap, "pswp__container"), d = a.container.style, a.itemHolders = k = [{ el: a.container.children[0], wrap: 0, index: -1 }, { el: a.container.children[1], wrap: 0, index: -1 }, { el: a.container.children[2], wrap: 0, index: -1 }], k[0].el.style.display = k[2].el.style.display = "none",
                                function() {
                                    if (_) { var e = R.perspective && !A; return b = "translate" + (e ? "3d(" : "("), void(y = R.perspective ? ", 0px)" : ")") }
                                    _ = "left", o.addClass(t, "pswp--ie"), At = function(t, e) { e.left = t + "px" }, Pt = function(t) {
                            ...
                            L || o.bind(a.scrollWrap, f, a), Ct("initialZoomInEnd", function() { a.setContent(k[0], u - 1), a.setContent(k[2], u + 1), k[0].el.style.display = k[2].el.style.display = "block", r.focus && t.focus(), o.bind(document, "keydown", a), R.transform && o.bind(a.scrollWrap, "click", a), r.mouseUsed || o.bind(document, "mousemove", Ft), o.bind(window, "resize scroll", a), St("bindEvents") }), a.setContent(k[1], u), a.updateCurrItem(), St("afterInit"), vt || (x = setInterval(function() { Yt || j || Z || v !== a.currItem.initialZoomLevel || a.updateSize() }, 1e3)), o.addClass(t, "pswp--visible")
                        }
                    },
                    ...
                    destroy: function() { St("destroy"), Le && clearTimeout(Le), t.setAttribute("aria-hidden", "true"), t.className = D, x && clearInterval(x), o.unbind(a.scrollWrap, f, a), o.unbind(window, "scroll", a), pe(), Ut(), kt = null },
                    panTo: function(t, e, i) { i || (t > J.min.x ? t = J.min.x : t < J.max.x && (t = J.max.x), e > J.min.y ? e = J.min.y : e < J.max.y && (e = J.max.y)), ut.x = t, ut.y = e, _t() },
                    ...
                    zoomTo: function(t, e, i, n, a) {
                        ...
                        var l = v,
                            ...
                            u = ut.y;
                        Et(s);
                        var d = function(e) { 1 === e ? (v = t, ut.x = s.x, ut.y = s.y) : (v = (t - l) * e + l, ut.x = (s.x - c) * e + c, ut.y = (s.y - u) * e + u), a && a(e), _t(1 === e) };
                ...
                pe = function() { U && ($(U), U = null) },
                fe = function() { j && (U = I(fe), _e()) },
                    ...
                    if (Q) {
                        ...
                        if (0 !== t)
                            if (Dt(Zt, Q[0]), Jt.x = Zt.x - te.x, Jt.y = Zt.y - te.y, Z && t > 1) {
                                ...
                                if ("v" === it && r.closeOnVerticalDrag && "fit" === r.scaleMode && v === a.currItem.initialZoomLevel) { lt.y += Jt.y, ut.y += Jt.y; var c = xe(); return N = !0, St("onVerticalDrag", c), Tt(c), void _t() }(function(t, e, i) {
                                    if (t - V > 50) {
                ...
                Pe = function(t) {
                    ...
                    1 === l && Dt(ee, s[0]), 0 !== l || it || et || (e || ("mouseup" === t.type ? e = { x: t.pageX, y: t.pageY, type: "mouse" } : t.changedTouches && t.changedTouches[0] && (e = { x: t.changedTouches[0].pageX, y: t.changedTouches[0].pageY, type: "touch" })), St("touchRelease", t, e));
                    var c = -1;
                    if (0 === l && (j = !1, o.unbind(window, p, a), pe(), Z ? c = 0 : -1 !== le && (c = Mt() - le)), le = 1 === l ? Mt() : -1, n = -1 !== c && 150 > c ? "zoom" : "swipe", Z && 2 > l && (Z = !1, 1 === l && (n = "zoomPointerUp"), St("zoomGestureEnded")), Q = null, X || q || et || N)
                        if (Ut(), H || (H = Ae()), H.calculateSwipeSpeed("x"), N)
                            if (xe() < r.verticalDragRange) a.close();
                                ...
                                var u = ut.y,
                                    d = at;
                                Kt("verticalDrag", 0, 1, 300, o.easing.cubic.out, function(t) { ut.y = (a.currItem.initialPosition.y - u) * t + u, Tt((1 - d) * t + d), _t() }), St("onVerticalDrag", 1)
                            }
                    else {
                        if ((K || et) && 0 === l) {
                            if ($e(n, H)) return;
            ...
            xt("Gestures", {
                publicMethods: {
                    initGestures: function() {
                        var t = function(t, e, i, n, o) { S = t + e, M = t + i, T = t + n, O = o ? t + o : "" };
            ...
            var Le, Fe, Re, We, Ve, He, ze = function(e, i, n, s) {
                    ...
                    if (!d || !l || void 0 === l.x) return St("initialZoom" + (n ? "Out" : "In")), v = e.initialZoomLevel, Dt(ut, e.initialPosition), _t(), t.style.opacity = n ? 0 : 1, Tt(1), void(d ? setTimeout(function() { h() }, d) : h());
                    ! function() {
                        var i = c,
                            s = !a.currItem.src || a.currItem.loadError || r.showHideOpacity;
                        e.miniImg && (e.miniImg.style.webkitBackfaceVisibility = "hidden"), n || (v = l.w / e.w, ut.x = l.x, ut.y = l.y - E, a[s ? "template" : "bg"].style.opacity = .001, _t()), Xt("initialZoom"), n && !i && o.removeClass(t, "pswp--animated-in"), s && (n ? o[(i ? "remove" : "add") + "Class"](t, "pswp--animate_opacity") : setTimeout(function() { o.addClass(t, "pswp--animate_opacity") }, 30)), Le = setTimeout(function() {
                            if (St("initialZoom" + (n ? "Out" : "In")), n) {
                                var a = l.w / e.w,
                                    r = { x: ut.x, y: ut.y },
                                    c = v,
                                    u = at,
                                    p = function(e) { 1 === e ? (v = a, ut.x = l.x, ut.y = l.y - F) : (v = (a - c) * e + c, ut.x = (l.x - r.x) * e + r.x, ut.y = (l.y - F - r.y) * e + r.y), _t(), s ? t.style.opacity = 1 - e : Tt(u - e * u) };
                ...
                Ye = function(t, e, i) {
                    if (t.src && !t.loadError) {
                        var n = !i;
                        if (n && (t.vGap || (t.vGap = { top: 0, bottom: 0 }), St("parseVerticalMargin", t)), Ne.x = e.x, Ne.y = e.y - t.vGap.top - t.vGap.bottom, n) {
                            var o = Ne.x / t.w,
                                a = Ne.y / t.h;
                            t.fitRatio = a > o ? o : a;
                            var s = r.scaleMode;
                ...
                publicMethods: {
                    ...
                    onTapRelease: function(t, e) {
                        if (e && !X && !Y && !Yt) {
                            ...
                            Dt(Je, i), Ze = setTimeout(function() { ti(t, e), Ze = null }, 300)
                        }
                    }
                }
            }), xt("DesktopZoom", {
                publicMethods: {
                    initDesktopZoom: function() { L || (A ? Ct("mouseUsed", function() { a.setupDesktopZoom() }) : a.setupDesktopZoom(!0)) },
    ...
    function(t, e) { "function" == typeof define && define.amd ? define(e) : "object" == typeof exports ? module.exports = e() : window.PhotoSwipeUI_Default = e() }(0, function() {
        "use strict";
        return function(t, e) {
            var i, n, o, a, r, s, l, c, u, d, h, p, f, m, v, g, b, y, x = this,
                ...
                O = function(t, i, n) { e[(n ? "add" : "remove") + "Class"](t, "pswp__" + i) },
                _ = function() {
                    var t = 1 === v.getNumItemsFn();
                    t !== m && (O(n, "ui--one-slide", t), m = t)
                },
                P = function() { O(l, "share-modal--hidden", C) },
                A = function() { return (C = !C) ? (e.removeClass(l, "pswp__share-modal--fade-in"), setTimeout(function() { C && P() }, 300)) : (P(), setTimeout(function() { C || e.addClass(l, "pswp__share-modal--fade-in") }, 30)), C || $(), !1 },
                I = function(e) { var i = (e = e || window.event).target || e.srcElement; return t.shout("shareLinkClick", e, i), !(!i.href || !i.hasAttribute("download") && (window.open(i.href, "pswp_share", "scrollbars=yes,resizable=yes,toolbar=no,location=yes,width=550,height=420,top=100,left=" + (window.screen ? Math.round(screen.width / 2 - 275) : 100)), C || A(), 1)) },
                $ = function() {
...
initPhotoSwipeFromDOM(".mdb-lightbox"),
    function(t, e) { "object" == typeof exports && "undefined" != typeof module ? module.exports = e() : "function" == typeof define && define.amd ? define(e) : (t = t || self).PerfectScrollbar = e() }(this, function() {
        "use strict";
        ...
        function a(t) { t.remove ? t.remove() : t.parentNode && t.parentNode.removeChild(t) }

        function r(t, e) { return Array.prototype.filter.call(t.children, function(t) { return o(t, e) }) }
        ...
        function f(t) { if ("function" == typeof window.CustomEvent) return new CustomEvent(t); var e = document.createEvent("CustomEvent"); return e.initCustomEvent(t, !1, !1, void 0), e }
        ...
        function m(t, e, i, n, o) {
            ...
            if (void 0 === n && (n = !0), void 0 === o && (o = !1), "top" === e) a = ["contentHeight", "containerHeight", "scrollTop", "y", "up", "down"];
                ...
                e && (p.dispatchEvent(f("ps-scroll-" + l)), e < 0 ? p.dispatchEvent(f("ps-scroll-" + d)) : e > 0 && p.dispatchEvent(f("ps-scroll-" + h)), n && function(t, e) { c(t, e), u(t, e) }(t, l));
                t.reach[l] && (e || o) && p.dispatchEvent(f("ps-" + l + "-reach-" + t.reach[l]))
            }(t, i, a, n, o)
        }

        function v(t) { return parseInt(t, 10) || 0 }
        p.prototype.eventElement = function(t) { var e = this.eventElements.filter(function(e) { return e.element === t })[0]; return e || (e = new d(t), this.eventElements.push(e)), e }, p.prototype.bind = function(t, e, i) { this.eventElement(t).bind(e, i) }, p.prototype.unbind = function(t, e, i) {
            var n = this.eventElement(t);
            n.unbind(e, i), n.isEmpty && this.eventElements.splice(this.eventElements.indexOf(n), 1)
        }, p.prototype.unbindAll = function() { this.eventElements.forEach(function(t) { return t.unbindAll() }), this.eventElements = [] }, p.prototype.once = function(t, e, i) {
            var n = this.eventElement(t),
        ...
        function b(t) {
            ...
            t.containerWidth = Math.ceil(o.width), t.containerHeight = Math.ceil(o.height), t.contentWidth = i.scrollWidth, t.contentHeight = i.scrollHeight, i.contains(t.scrollbarXRail) || (r(i, s.element.rail("x")).forEach(function(t) { return a(t) }), i.appendChild(t.scrollbarXRail)), i.contains(t.scrollbarYRail) || (r(i, s.element.rail("y")).forEach(function(t) { return a(t) }), i.appendChild(t.scrollbarYRail)), !t.settings.suppressScrollX && t.containerWidth + t.settings.scrollXMarginOffset < t.contentWidth ? (t.scrollbarXActive = !0, t.railXWidth = t.containerWidth - t.railXMarginWidth, t.railXRatio = t.containerWidth / t.railXWidth, t.scrollbarXWidth = y(t, v(t.railXWidth * t.containerWidth / t.contentWidth)), t.scrollbarXLeft = v((t.negativeScrollAdjustment + i.scrollLeft) * (t.railXWidth - t.scrollbarXWidth) / (t.contentWidth - t.containerWidth))) : t.scrollbarXActive = !1, !t.settings.suppressScrollY && t.containerHeight + t.settings.scrollYMarginOffset < t.contentHeight ? (t.scrollbarYActive = !0, t.railYHeight = t.containerHeight - t.railYMarginHeight, t.railYRatio = t.containerHeight / t.railYHeight, t.scrollbarYHeight = y(t, v(t.railYHeight * t.containerHeight / t.contentHeight)), t.scrollbarYTop = v(n * (t.railYHeight - t.scrollbarYHeight) / (t.contentHeight - t.containerHeight))) : t.scrollbarYActive = !1, t.scrollbarXLeft >= t.railXWidth - t.scrollbarXWidth && (t.scrollbarXLeft = t.railXWidth - t.scrollbarXWidth), t.scrollbarYTop >= t.railYHeight - t.scrollbarYHeight && (t.scrollbarYTop = t.railYHeight - t.scrollbarYHeight),
                function(t, i) {
                    ...
                    e(i.scrollbarYRail, a), e(i.scrollbarX, { left: i.scrollbarXLeft, width: i.scrollbarXWidth - i.railBorderXWidth }), e(i.scrollbarY, { top: i.scrollbarYTop, height: i.scrollbarYHeight - i.railBorderYWidth })
        ...
        function x(t, e) {
            ...
            function y(e) { e.touches && e.touches[0] && (e[o] = e.touches[0].pageY), f[d] = m + g * (e[o] - v), c(t, h), b(t), e.stopPropagation(), e.preventDefault() }

            function x() { u(t, h), t[p].classList.remove(s.state.clicking), t.event.unbind(t.ownerDocument, "mousemove", y) }

            function w(e, r) { m = f[d], r && e.touches && (e[o] = e.touches[0].pageY), v = e[o], g = (t[n] - t[i]) / (t[a] - t[l]), r ? t.event.bind(t.ownerDocument, "touchmove", y) : (t.event.bind(t.ownerDocument, "mousemove", y), t.event.once(t.ownerDocument, "mouseup", x), e.preventDefault()), t[p].classList.add(s.state.clicking), e.stopPropagation() }
            t.event.bind(t[r], "mousedown", function(t) { w(t) }), t.event.bind(t[r], "touchstart", function(t) { w(t, !0) })
        }
        var w = {
                ...
                keyboard: function(t) {
                    ...
                    t.event.bind(t.ownerDocument, "keydown", function(i) {
                        if (!(i.isDefaultPrevented && i.isDefaultPrevented() || i.defaultPrevented) && (o(e, ":hover") || o(t.scrollbarX, ":focus") || o(t.scrollbarY, ":focus"))) {
                            ...
                            t.settings.suppressScrollX && 0 !== r || t.settings.suppressScrollY && 0 !== s || (e.scrollTop -= s, e.scrollLeft += r, b(t), function(i, n) { var o = Math.floor(e.scrollTop); if (0 === i) { if (!t.scrollbarYActive) return !1; if (0 === o && n > 0 || o >= t.contentHeight - t.containerHeight && n < 0) return !t.settings.wheelPropagation } var a = e.scrollLeft; if (0 === n) { if (!t.scrollbarXActive) return !1; if (0 === a && i < 0 || a >= t.contentWidth - t.containerWidth && i > 0) return !t.settings.wheelPropagation } return !0 }(r, s) && i.preventDefault())
                        }
                    })
                },
                wheel: function(e) {
                    ...
                    function n(n) {
                        ...
                        if (! function(e, n, o) {
                                ...
                                for (var a = e; a && a !== i;) {
                                    ...
                                    var r = t(a);
                                    if (o && r.overflowY.match(/(scroll|auto)/)) { var l = a.scrollHeight - a.clientHeight; if (l > 0 && (a.scrollTop > 0 && o < 0 || a.scrollTop < l && o > 0)) return !0 }
                ...
                touch: function(e) {
                    ...
                    function l(t, n) { i.scrollTop -= n, i.scrollLeft -= t, b(e) }
                            ...
                            v > 0 && (a.x = p / v, a.y = f / v, o = m),
                                function(t, n) {
                                    var o = Math.floor(i.scrollTop),
                                        ...
                                        r = Math.abs(t),
                                        s = Math.abs(n);
                                    if (s > r) { if (n < 0 && o === e.contentHeight - e.containerHeight || n > 0 && 0 === o) return 0 === window.scrollY && n > 0 && g.isChrome } else if (r > s && (t < 0 && a === e.contentWidth - e.containerWidth || t > 0 && 0 === a)) return !0;
                                    return !0
                                }(p, f) && r.preventDefault()
                        }
                    }

                    function p() { e.settings.swipeEasing && (clearInterval(r), r = setInterval(function() { e.isInitialized ? clearInterval(r) : a.x || a.y ? Math.abs(a.x) < .01 && Math.abs(a.y) < .01 ? clearInterval(r) : (l(30 * a.x, 30 * a.y), a.x *= .8, a.y *= .8) : clearInterval(r) }, 10)) }
                }
            },
            k = function(n, o) {
                var a = this;
                ...
                for (var r in this.element = n, n.classList.add(s.main), this.settings = { handlers: ["click-rail", "drag-thumb", "keyboard", "wheel", "touch"], maxScrollbarLength: null, minScrollbarLength: null, scrollingThreshold: 1e3, scrollXMarginOffset: 0, scrollYMarginOffset: 0, suppressScrollX: !1, suppressScrollY: !1, swipeEasing: !0, useBothWheelAxes: !1, wheelPropagation: !0, wheelSpeed: 1 }, o) this.settings[r] = o[r];
        ...
        var e = function() {
            function e(e, i) { void 0 === i && (i = {}), this.$chipsWrapper = e, this.options = "string" == typeof i ? i : { data: this.fallback().or(i.data).or([]).value(), dataChip: this.fallback().or(i.dataChip).or([]).value(), placeholder: this.fallback().or(e.attr("data-placeholder")).or(i.placeholder).or("").value(), secondaryPlaceholder: this.fallback().or(e.attr("data-secondary-placeholder")).or(i.secondaryPlaceholder).or("").value(), sortAutocompleteData: this.fallback().or(e.attr("data-sort-autocomplete-data")).or(i.sortAutocompleteData).or(!0).value(), autocompleteDataCompareFn: this.fallback().or(i.autocompleteDataCompareFn).or(void 0).value() }, this.$autocompleteList = t('<ul class="chip-ul z-depth-1" tabindex="0"></ul>'), this.keyCodes = { backspace: 8, enter: 13, arrowLeft: 37, arrowRight: 39, delete: 46, comma: 188 } }
            var i = e.prototype;
            return i.getSelectedChip = function() { return this.$chipsWrapper.find(".chip.selected") }, i.returnPublicInterface = function() { return "data" === this.options ? this.$chipsWrapper.data("chips") : "options" === this.options ? this.$chipsWrapper.data("options") : this.$chipsWrapper }, i.init = function() { this.isPublicInterfaceCall || (this.assignOptions(), this.isInitialized || (this.$chipsWrapper.data({ chips: this.options.data.slice(), index: this.$chipsWrapper.index(), initialized: !0 }), this.$chipsWrapper.attr("tabindex", 0), this.$chipsWrapper.hasClass(".chips") || this.$chipsWrapper.addClass("chips"), this.renderChips(), this.bindEvents())) }, i.assignOptions = function() { Array.isArray(this.options.data) || (this.options.data = []), this.$chipsWrapper.data("options", Object.assign({}, this.options)) }, i.bindEvents = function() { this.bindChipsWrapperClick(), this.bindChipsWrapperBlur(), this.bindSingleChipClick(), this.bindChipsWrapperKeydown(), this.bindChipsInputClick(), this.bindChipsInputFocusout(), this.bindChipsInputKeydown(), this.bindDeleteButtonClick(), this.bindAutocompleteInputKeyup(), this.bindAutocompleteOptionClick() }, i.bindChipsWrapperClick = function() { this.$chipsWrapper.on("click", function(e) { return t(e.target).find("input").focus().addClass("active") }) }, i.bindChipsWrapperBlur = function() {
                var e = this;
                ...
                i.on("keyup", function(n) {
                    var o = i.val();
                    e.$autocompleteList.empty(), o.length ? (e.options.dataChip.forEach(function(i) { i.toLowerCase().includes(o.toLowerCase()) && e.$chipsWrapper.find(".chip-position-wrapper").append(e.$autocompleteList.append(t("<li>" + i + "</li>"))) }), e.$autocompleteList.addClass("active").show()) : e.$autocompleteList.removeClass("active").hide();
            ...
            }, i.selectLeftChip = function() { this.selectLeftRightChip(!0) }, i.selectRightChip = function() { this.selectLeftRightChip(!1) }, i.selectLeftRightChip = function(t) {
            ...
            }, i.getSingleChipTemplate = function(t) { if (!t.tag) return ""; var e = '<div class="chip">' + t.tag; return t.image && (e += ' <img src="' + t.image + '" /> '), e += '<i class="close fas fa-times"></i>', e += "</div>" }, i.setPlaceholder = function() { this.$chipsWrapper.find("input").prop("placeholder", this.options.data.length ? this.options.placeholder : this.options.secondaryPlaceholder) }, i.addChip = function(e) {
                if (this.isValid(e)) {
            ...
            }, i.isValid = function(t) { return "" !== t.tag && !this.options.data.some(function(e) { return e.tag === t.tag }) }, i.deleteChip = function(t) {
            ...
            }, i.fallback = function() { return { _value: void 0, or: function(t) { return void 0 !== t && void 0 === this._value && (this._value = t), this }, value: function() { return this._value } } }, _createClass(e, [{ key: "isPublicInterfaceCall", get: function() { return "string" == typeof this.options } }, { key: "isInitialized", get: function() { return this.$chipsWrapper.data("initialized") } }]), e
        }();
...
var objectFitImages = function() {
    ...
    function h(i) {
        var o = function(t) { for (var i, n = getComputedStyle(t).fontFamily, o = {}; null !== (i = e.exec(n));) o[i[1]] = i[2]; return o }(i),
            a = i[t];
        if (o["object-fit"] = o["object-fit"] || "fill", !a.img) { if ("fill" === o["object-fit"]) return; if (!a.skipTest && n && !o["object-position"]) return }
        if (!a.img) {
        ...
        }(a.img), i.style.backgroundImage = 'url("' + (a.img.currentSrc || a.img.src).replace(/"/g, '\\"') + '")', i.style.backgroundPosition = o["object-position"] || "center", i.style.backgroundRepeat = "no-repeat", i.style.backgroundOrigin = "content-box", /scale-down/.test(o["object-fit"]) ? d(a.img, function() { a.img.naturalWidth > i.width || a.img.naturalHeight > i.height ? i.style.backgroundSize = "contain" : i.style.backgroundSize = "auto" }) : i.style.backgroundSize = o["object-fit"].replace("none", "auto").replace("fill", "100% 100%"), d(a.img, function(t) { u(i, t.naturalWidth, t.naturalHeight) })
    }
    ...
    function p(e, i) {
        ...
        n && (document.body.addEventListener("load", function(t) { "IMG" === t.target.tagName && p(t.target, { skipTest: i.skipTest }) }, !0), c = !0, e = "img"), i.watchMQ && window.addEventListener("resize", p.bind(null, e, { skipTest: i.skipTest }))
    }
...
function(t) {
    var e = function() {
        ...
        return i.init = function() { this.handleEvents() }, i.handleEvents = function() { this.setData(), this.inputFocus(), this.inputBlur(), this.inputKeyupData(), this.inputLiClick(), this.clearAutocomplete(), this.setAutocompleteWrapHeight() }, i.assignOptions = function(e) { return t.extend({}, this.defaults, e) }, i.setAutocompleteWrapHeight = function() { this.$autocompleteWrap.css("max-height", 45 * this.options.visibleOptions + "px") }, i.setData = function() { Object.keys(this.options.data).length && this.$autocompleteWrap.insertAfter(this.$input) }, i.inputFocus = function() {
        ...
        }, i.endHandler = function(t, e) { this.count = e.length - 1, this.nextScrollHeight = 45 * e.length - 45, t.scrollTop(45 * e.length), e.eq(-1).addClass("selected") }, i.homeHandler = function(t, e) { this.count = 0, this.nextScrollHeight = -45, t.scrollTop(0), e.eq(0).addClass("selected") }, i.arrowDownHandler = function(t, e, i) {
        ...
        }, i.arrowUpHandler = function(t, e, i, n) { this.count < 1 ? (this.count = e.length, t.scrollTop(t.prop("scrollHeight")), this.nextScrollHeight = t.prop("scrollHeight") - i) : this.count--, this.nextScrollHeight -= n, t.scrollTop(this.nextScrollHeight), e.eq(this.count).addClass("selected") }, i.appendOptions = function(e, i) {
            for (var n in e)
            ...
            var t = this;
            this.$input.hasClass("mdb-autocomplete") && (this.$input.on("keyup", function(e) { t.fillSVG(e, t.options.closeColor) }), this.$input.on("blur", function(e) { t.fillSVG(e, t.options.closeBlurColor) }))
        }, i.fillSVG = function(e, i) { e.preventDefault(), t(e.target).parent().find(".mdb-autocomplete-clear").find("svg").css("fill", i) }, e
    }();
    t.fn.mdbAutocomplete = function(i) { return this.each(function() { new e(t(this), i).init() }) }
}(jQuery),
function(t) { t("body").on("shown.bs.modal", ".modal", function() { t(".modal-backdrop").length || ($modal_dialog = t(this).children(".modal-dialog"), $modal_dialog.hasClass("modal-side") && (t(this).addClass("modal-scrolling"), t("body").addClass("scrollable")), $modal_dialog.hasClass("modal-frame") && (t(this).addClass("modal-content-clickable"), t("body").addClass("scrollable"))) }), t("body").on("hidden.bs.modal", ".modal", function() { t("body").removeClass("scrollable") }) }(jQuery), jQuery(function(t) {
